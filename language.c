...
void loadLanguage(int id) {
  ...
  ConfigEntry language_entries[] = {
	...
	LANGUAGE_ENTRY(VITASHELL_SETTINGS_OVERWRITE_FILES),
    ...
    LANGUAGE_ENTRY(VITASHELL_SETTINGS_OVERWRITE_ALWAYS),
    LANGUAGE_ENTRY(VITASHELL_SETTINGS_OVERWRITE_RENAME),
	LANGUAGE_ENTRY(VITASHELL_SETTINGS_OVERWRITE_SKIP),
