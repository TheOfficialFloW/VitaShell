...
#define VITASHELL_VERSION_MINOR 6
...
enum DialogSteps {
	...
	DIALOG_STEP_SPLIT_QUESTION,
	DIALOG_STEP_SPLIT_CONFIRMED,
	DIALOG_STEP_SPLITTING,
	DIALOG_STEP_SPLITTED,

	DIALOG_STEP_JOIN_QUESTION,
	DIALOG_STEP_JOIN_CONFIRMED,
	DIALOG_STEP_JOINING,
	DIALOG_STEP_JOINED,
};
